...
export const updateUser = async (req, res) => {
  ...
  try {
    ...
    let user: User = (
      await firebaseHelper.firestore.checkDocumentExists(
        db,
        collectionName,
        body._id
      )
    ...
    if (body.testExamHistory) {
      user.testExamHistory.push(body.testExamHistory[0]);
      user.point += body.testExamHistory[0].point;
      body.testExamHistory = user.testExamHistory;
      body.point = user.point;
    }
